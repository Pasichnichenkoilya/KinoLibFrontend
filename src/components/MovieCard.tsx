  ...
  return (
    <Link to={`/details${entry.id}`}>
      <div className="card_size relative cursor-pointer">
        ...
        <div
          className={`w-${
            entry.lastEpisode ? "10" : "2"
          }rem h-1rem bg-gray-900 top-0 left-0 absolute m-2 flex flex-row align-items-center justify-content-center gap-1 border-round opacity-70`}>
          {entry.lastEpisode ? (
            <>
              <img
                src={require("../images/film-outline.png")}
                className="h-1rem"
                alt="film icon"></img>
            ...
            <div className="flex justify-content-center align-items-center">
              <img
                src={require("../images/videocam-outline.png")}
                className="h-1rem"
                alt="film icon"></img>
            </div>
          )}
