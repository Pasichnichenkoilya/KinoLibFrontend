...
const Navbar = () => {
  ...
  return (
    <div className='flex flex-row justify-content-center w-full fixed'>
            ...
            <div className="w-full mt-1">
              <div className=' ml-auto mr-auto'>
                <div className='test_under_2 ml-auto mr-auto justify-content-center flex'>
                  <div className='h-8rem  ml-5 mr-5 align-items-center flex flex-rom justify-content-between pt-7'>
                    <Link to = "/">
